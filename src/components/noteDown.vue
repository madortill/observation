    ...
    methods: {
        ...
        checkWhenPractice(event) {
            ...
            if (this[`option${numberOfArray}`].correctAnswer === event.currentTarget.value) {
                this[`option${numberOfArray}`].isCorrect = '/Users/shiracohen/observation/src/assets/check.png';
                this.correctCounter++;
                this[`option${numberOfArray}`].disabled = true;
            } else {
                this[`option${numberOfArray}`].isCorrect = '/Users/shiracohen/observation/src/assets/cancel.png';
            }
